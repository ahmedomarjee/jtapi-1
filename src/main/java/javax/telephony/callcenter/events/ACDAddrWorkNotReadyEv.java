...
/**
 * The <CODE>ACDAddrWorkNotReadyEv</CODE> interface indicates that an Agent has
 * moved into the <CODE>Agent.WORK_NOT_READY</CODE> state. This interface
 * extends the <CODE>ACDAddrEv</CODE> interface and is reported via the
