...
/**
 * The <CODE>AgentTermLoggedOnEv</CODE> interface indicates that an Agent has
 * moved into the <CODE>Agent.LOG_IN</CODE> state. This interface extends the
 ...
 */
public interface AgentTermLoggedOnEv extends AgentTermEv {
