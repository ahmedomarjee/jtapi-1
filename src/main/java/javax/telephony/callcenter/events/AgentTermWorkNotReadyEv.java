...
/**
 * The <CODE>AgentTermWorkNotReadyEv</CODE> interface indicates that an Agent
 * has moved into the <CODE>Agent.WORK_NOT_READY</CODE> state. This interface
 * extends the <CODE>AgentTermEv</CODE> interface and is reported via the
 ...
 */
public interface AgentTermWorkNotReadyEv extends AgentTermEv {
