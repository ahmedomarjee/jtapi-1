/*
#pragma ident "@(#)CallCentTrunkInvalidEv.java	1.4      99/02/09     SMI"
...
/**
 * The <CODE>CallCentTrunkInvalidEv</CODE> interface indicates that a Trunk
 * has moved into the <CODE>CallCenterTrunk.INVALID_TRUNK</CODE> state. This
