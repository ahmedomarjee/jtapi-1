...
/**
 * The <CODE>CallCtlConnDialingEv</CODE> interface indicates that the call
 * control package state of the Connection is now
 * <CODE>CallControlConnection.DIALING</CODE>. This method
 ...
 * <p>
 * This interface supports the <CODE>getDigits()</CODE> method which returns
 * the digits which have already been dialed.
 * <p>
...
public interface CallCtlConnDialingEv extends CallCtlConnEv {
