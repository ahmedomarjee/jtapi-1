...
/**
 * The <CODE>CallCtlConnInitiatedEv</CODE> interface indicates that the call
 * control package state of the Connection is now
 * <CODE>CallControlConnection.INITIATED</CODE>. This method
...
public interface CallCtlConnInitiatedEv extends CallCtlConnEv {
