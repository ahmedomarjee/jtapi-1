/*
#pragma ident "@(#)PrivateTermEv.java	1.3      96/11/03     SMI"
...
/**
 * The <CODE>PrivateTermEv</CODE> interface sends platform-specific event
 * information to a <CODE>TerminalObserver</CODE>. This interface extends the
 * core <CODE>TermEv</CODE> interface. This event could be a stand-alone event
